let video_con = document.querySelector(".video_con")
let songName = document.querySelector(".songName")
let issueDate = document.querySelector(".issueDate")
let creator = document.querySelector(".creator")
let v_imgAll = document.querySelectorAll(".v_img")
let videoArr = [
    'video/video1.mp4',
    'video/video2.mp4',
    'video/video3.mp4',
...
for(let i = 0; i < v_imgAll.length; i++){
    v_imgAll[i].onclick = function () {
        video_con.src = videoArr[i]
        video_con.poster = songs[i].imgSrc
        songName.innerHTML = songs[i].songName
        issueDate.innerHTML = songs[i].issueDate
        creator.innerHTML = songs[i].creator
    }
}
